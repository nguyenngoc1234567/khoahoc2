...
?>
 ...
 <label for="">Nhập tên </label><br>
   <input type="text"  name="nhapten" ><br>
   <label for="">Nhập nhap email:</label><br>
   <input type="text"  name="nhapemail" ><br>
   <label for="">Nhập role :</label><br>
   <input type="text"  name="nhaprole" ><br>
